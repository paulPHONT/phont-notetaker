...
import { GoetheHomeScreen } from "@/components/demo/GoetheHomeScreen";
...
const GoetheDemo = () => {
  ...
  const renderContent = () => {
    ...
    if (activePanel) {
      switch (activePanel) {
        ...
        default:
          return <GoetheHomeScreen onNavigate={handleNavigate} onInfoClick={handleInfoClick} />;
      }
    }
  ...
  return (
    <div className="min-h-screen bg-background dark">
      <Header 
        title={getTitle()} 
        eventTitle={isHome ? "Goethe SDG Contest" : undefined}
